...
// Define your query
$query = "SELECT * FROM sabangtoda_2024 WHERE 1=1"; // Initial query

// Count total number of records
$totalRecordsQuery = "SELECT COUNT(*) AS total FROM sabangtoda_2024";
...
// Define your query
// $query = "SELECT * FROM sabangtoda_2024";
